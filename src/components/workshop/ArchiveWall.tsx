...
export default function ArchiveWall() {
  return (
    <div
      data-plate="archive"
      className="concrete-wash plate-seam ruling-grid relative flex-none w-screen md:w-[min(120vw,80rem)] md:h-full flex flex-col justify-center px-6 md:px-14 py-20 md:py-[14vh]"
      style={{ background: "var(--tint-slate)" }}
    >
